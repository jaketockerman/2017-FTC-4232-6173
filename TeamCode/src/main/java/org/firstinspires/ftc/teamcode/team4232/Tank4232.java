...
@Disabled
public class Tank4232 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
      ...
      /*  telemetry.addData("Left Flip Servo: ", "%.2f", robot.leftFlip.getPosition());
        ...
        while (opModeIsActive()) {
            ...
            //servos
            leftBallValue = gamepad2.left_trigger;
            rightBallValue = gamepad2.right_trigger;
            leftFlipValue = gamepad1.left_trigger;
            rightFlipValue = gamepad1.right_trigger;
            beaconFlipValue = gamepad2.right_bumper;
